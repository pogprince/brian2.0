      ...
      <div className="w-full max-w-sm">
        ...
        <div className="card-padded">
          ...
          {hasGoogle && (
            <>
              <button
                ...
                className="btn-secondary w-full mb-4 flex items-center justify-center gap-3"
              >
              ...
              <div className="relative mb-4">
                ...
                <div className="relative flex justify-center text-xs">
                  <span className="px-2 bg-white text-ink-4">or sign in with username</span>
                </div>
              </div>
            </>
          )}
          ...
          <div className="mt-4 text-center">
            <Link href="/register" className="text-sm text-brain-600 hover:text-brain-700">
              Create an account
            </Link>
          </div>
        </div>
